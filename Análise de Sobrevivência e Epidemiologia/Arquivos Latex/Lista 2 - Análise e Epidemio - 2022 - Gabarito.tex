...
\begin{document}
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\begin{axis}[ybar interval, ymin=0, ymax=5, xmin=1, xmax=11]
			\addplot coordinates {(1,0) (2,0) (3, 2) (4,0) (5,0) (6,0) (7,0) (8,0) (9,0) (10,0) (11,0)};
			\end{axis}
		\end{tikzpicture}
		}
		\vspace{1cm}\\
		...
		\begin{tikzpicture}
			\tikzstyle{every node}=[font=\footnotesize]
			\begin{axis}[ybar interval, ymin=0, ymax=5, xmin=1, xmax=11]
			\addplot coordinates {(1, 3) (2,0) (3,0) (4,0) (5,1) (6,0) (7,1) (8,1) (9,0) (10,1) (11,0)};
			\end{axis}
		\end{tikzpicture}
		}	
	\end{center}
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\addplot coordinates {(1,0) (2,0) (3, 1) (4,1) (5,1) (6,2) (7,0) (8,0) (9,0) (10,1) (11,0) (12,1) (13,0) (14,0) (15,1) (16,0)};
			\end{axis}
		\end{tikzpicture}
		}
	\end{center}
	...
	\begin{center}
		...
		\resizebox{400px}{300px}{
		\begin{tikzpicture}
			\tikzstyle{every node}=[font=\scriptsize]
			\begin{axis}[ybar interval, ymin=0, ymax=6, xmin=5, xmax=26]
			\addplot coordinates {(5,0) (6,0) (7, 1) (8,4) (9,0) (10,0) (11,0) (12,2) (13,0) (14,0) (15,0) (16,0) (17,1) (18,1) (19,0) (20,0) (21,0) (22,1) (23,0) (24,0) (25,0) (26,0)};
			\end{axis}	
		\end{tikzpicture}
		}
		\vspace{1cm}\\
		...
		\begin{tikzpicture}
			\tikzstyle{every node}=[font=\scriptsize]
			\begin{axis}[ybar interval, ymin=0, ymax=6, xmin=5, xmax=26]
			\addplot coordinates {(5,0) (6,0) (7, 0) (8,2) (9,1) (10,2) (11,0) (12,0) (13,0) (14,1) (15,2) (16,0) (17,0) (18,1) (19,1) (20,0) (21,0) (22,2) (23,1) (24,0) (25,1) (26,0)};
			\end{axis}	
		\end{tikzpicture}
		}
	\vspace{1cm}\\
	...
	\resizebox{400px}{300px}{
		\begin{tikzpicture}
			\tikzstyle{every node}=[font=\scriptsize]
			\begin{axis}[ybar interval, ymin=0, ymax=6, xmin=5, xmax=26]
			\addplot coordinates {(5,0) (6,0) (7, 0) (8,6) (9,1) (10,3) (11,1) (12,0) (13,0) (14,0) (15,0) (16,0) (17,1) (18,0) (19,1) (20,0) (21,0) (22,0) (23,0) (24,0) (25,0) (26,0)};
			\end{axis}	
		\end{tikzpicture}
	}
	\end{center}
	\vspace{1cm}
	Os histoogramas dos grupos 1 e 3 indicam um pico na mortalidade dos indvíduos uma semana, oitavo dia, após início do estudo que vai estabilizando em níveis mais baixos nos dias posteriores, já no grupo 2 apresenta uma taxa quase constante ao longo de todo o período de estudo, tendo uma variação de no máximo duas mortes entres dias consecutivos.
	\vspace{1cm}\\
	\textbf{3.1.1 Estimador Kaplan-Meier}
	\vspace{1cm}\\
	\begin{center}
		\resizebox{\linewidth}{!}{
		\begin{tabular}{ccccccc}\midrule
	...
	\vspace{1cm}\\
	\textbf{3.2 Estimador de Nelson-Aalen}
	\vspace{1cm}\\
	\begin{center}
		\resizebox{\linewidth}{!}{
		\begin{tabular}{ccccccc}\midrule
